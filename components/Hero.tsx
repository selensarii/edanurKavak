...
export default function Hero() {
  return (
    <section id="home" className="relative px-4 sm:px-6 lg:px-8 overflow-hidden flex items-center min-h-[calc(100vh-5rem)]">
      {/* Decorative Blobs */}
      ...
      <div className="max-w-7xl mx-auto w-full py-12 lg:py-20 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-accent leading-tight">
              Birey Odaklı <br />
              <span className="opacity-70 italic">Psikoterapi</span> Süreci.
            </h1>
            <p className="text-lg text-body max-w-lg leading-relaxed text-justify">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex justify-center items-center bg-primary text-accent font-medium px-8 py-4 rounded-full hover:bg-primary/90 transition-all hover:-translate-y-1 hover:shadow-lg"
              >
                Randevu Al
              </a>
              <a
                ...
                className="inline-flex justify-center items-center bg-transparent border-2 border-primary/30 text-accent font-medium px-8 py-4 rounded-full hover:border-primary hover:bg-primary/5 transition-all"
              >
                Çalışma Alanları
              </a>
            </div>
          ...
          <motion.div
            ...
            className="relative mx-auto lg:ml-auto lg:mr-0 max-w-xs sm:max-w-sm w-full"
          >
            ...
            <div className="relative aspect-[4/5] w-full rounded-[3rem] overflow-hidden border-8 border-background shadow-2xl bg-secondary/20">
              <Image
